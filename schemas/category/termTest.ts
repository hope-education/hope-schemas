...
export const createTermTestStructure = (S: StructureBuilder) =>
  S.listItem()
    .title('Term Test Model Papers')
    .id('termtest_root')
    .child(
      S.documentList()
        .title('Grades')
            ...
            .child((subjectId = '') => {
              ...
              return S.documentList()
                ...
                .child((termId = '') => {
                  ...
                  return S.documentList()
                    .title('Term Test Model Papers')
                    .filter('_type == "termTest" && grade._ref == $gradeId && subject._ref == $subjectId && term._ref == $termId')
                    .params({ gradeId, subjectId, termId })
                    .initialValueTemplates([
                      S.initialValueTemplateItem('termTest', {
